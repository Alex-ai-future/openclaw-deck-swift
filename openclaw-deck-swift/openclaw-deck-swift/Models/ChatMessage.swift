...
struct ChatMessage: Codable, Identifiable {
    ...
    init(id: String, role: MessageRole, text: String, timestamp: Date, streaming: Bool? = nil, thinking: Bool? = nil, toolUse: ToolUseInfo? = nil, runId: String? = nil, isLoaded: Bool = false) {
        self.id = id
        self.role = role
        self.text = text
